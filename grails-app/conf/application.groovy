...
security.cas.uriFilterPattern='/speciesList,/speciesList/upload,/speciesList/.*,/admin,/admin/.*,/editor,/editor/.*,/alaAdmin.*'
security.cas.authenticateOnlyIfLoggedInFilterPattern='/public,/public/*,/speciesListItem/list,/speciesListItem/list/.*,/speciesListItem/listAuth,/speciesListItem/listAuth/.*'
