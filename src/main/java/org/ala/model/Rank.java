...
public enum Rank {
    ...
    SUBORD      (4200, "suborder","subord", "subordo"),
    ...
    FORM        (8020, "form", "forma", "f", "f.","fm.", "fm", "[f.]", "form taxon"),
    ...
    SUBGEN      (6500, "subgenus","subgen", "infragenericname"),
    SUPERCL     (2800, "superclass", "supercl"),
    TRIB        (5600, "tribe","trib"),
    CV          (8050, "cultivar", "cv"),
    FAM         (5000, "family","fam"),
    SUBFAM      (5500, "subfamily", "subfam", "subf", "supragenericname"),
    SUBCL       (3200, "subclass", "subcl"),
    SUPERORD    (4200, "superorder", "superord", "superordo"),
