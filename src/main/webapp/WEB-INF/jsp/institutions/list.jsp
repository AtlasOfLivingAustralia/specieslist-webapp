            ...
            <div class="solrResults">
                <div id="sortWidget">
                    ...
                    <select id="sort" name="sort">
                        ...
                        <option value="name" <c:if test="${param.sort eq 'name'}">selected</c:if>>institution name</option>
                    </select>
                    sort order
                ...
                <table>
                    ...
                    <tbody>
                        <c:forEach var="institution" items="${searchResults.results}">
                            <tr>
                                <td id="col1"><a href="${institution.guid}">${institution.name}</a></td>
                                <td id="col2"></td>
                            </tr>
                        </c:forEach>
                    </tbody>
