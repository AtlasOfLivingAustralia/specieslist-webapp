                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><form:input path="scientificName"/> <form:errors path="scientificName" cssClass="error"/></td>
                                <td>User Name: </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form:select path="rank">
                                        <form:option value=""/>
                                        <form:option value="Kingdom"/>
                                        <form:option value="Phylum"/>
                                        <form:option value="Class"/>
                                        <form:option value="Order"/>
                                        <form:option value="Family"/>
                                        <form:option value="Genus"/>
                                        <form:option value="Species" />
                                        <form:option value="Subspecies" />
                                        <form:option value="Form" />
                                        <form:option value="Variety" />
                                    </form:select>  <form:errors path="rank" cssClass="error"/>
                                </td>
                            </tr>
                            <tr>
                                <td>Description:</td>
