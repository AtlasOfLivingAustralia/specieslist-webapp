...
<!--                        <li><a href="/biocache-webapp/occurrences/search?q=${param['q']}"><strike>Occurrence Records</strike></a></li>-->
            ...
            <div id="accordion">
                ...
                <%--
                <h3><a href="#" class="open">Taxonomic Rank</a></h3>
                <div id="subnavlist">
                    <ul>
                        <li class="filtered-by"><a href="">Any</a></li>
                        <li><a href="">Subspecies</a> <span>(7)</span></li>
                        <li><a href="">Species</a> <span>(85)</span></li>
                        <li><a href="">Genus</a> <span>(2)</span></li>
                        <li><a href="">Family</a> <span>(2)</span></li>
                    </ul>
                </div>
                <h3><a href="#" class="closed">Kingdom</a></h3>
                <div id="subnavlist">
                    <ul>
                        <li class="filtered-by"><a href="">Any</a></li>
                        <li><a href="">Animalia</a> <span>(62)</span></li>
                        <li><a href="">Plantae</a> <span>(25)</span></li>
                    </ul>
                </div>
                <h3><a href="#" class="closed">Pest Status</a></h3>
                <div id="subnavlist">
                    <ul>
                        <li class="filtered-by"><a href="">Any</a></li>
                        <li><a href="">Native</a> <span>(5)</span></li>
                        <li><a href="">Invasive</a> <span>(2)</span></li>
                    </ul>
                </div>
                <h3><a href="#" class="closed">Conservation Status</a></h3>
                <div id="subnavlist">
                    <ul>
                        <li class="filtered-by"><a href="">Any</a></li>
                        <li><a href="">Least Concern</a> <span>(35)</span></li>
                        <li><a href="">Vulnerable</a> <span>(7)</span></li>
                        <li><a href="">Near Threatened</a> <span>(2)</span></li>
                        <li><a href="">Endangered</a> <span>(8)</span></li>
                        <li><a href="">Critically Endangered</a> <span>(3)</span></li>
                        <li><a href="">Extinct</a> <span>(2)</span></li>
                    </ul>
                </div>
                --%>
            </div>
                ...
                <div id="sortWidget">
                    <!--<div id="searchTerms">
                            <div class="queryTermBox">
                                    Search: <a href="?q=kangaroo">kangaroo</a><a name="searchResults">&nbsp;</a>
                            </div>
                    </div>-->
        ...
        <div id="searchResults" style="display: none;">
            ...
            <div class="solrResults">
                <div id="sortWidget">
                    ...
                    <div id="resultsStats">
                        Returned <fmt:formatNumber value="${searchResults.totalRecords}" pattern="#,###,###"/> results
                    </div>
                    sort by
                    <select id="sort" name="sort">
                        <option value="score" <c:if test="${param.sort eq 'score'}">selected</c:if>>best match</option>
