                    ...
                    <c:choose>
                        <c:when test="${result.class.name == 'org.ala.dto.SearchTaxonConceptDTO'}">
                            <h4> 
                                ...
                                <a href="${pageContext.request.contextPath}/species/${result.guid}" class="occurrenceLink"><alatag:formatSciName rankId="${result.rankId}" name="${result.nameComplete}" acceptedName="${result.acceptedConceptName}"/> ${result.author}</a>
