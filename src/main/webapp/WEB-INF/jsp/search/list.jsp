                        ...
                        <c:when test="${result.class.name == 'org.ala.dto.SearchTaxonConceptDTO'}">
                            ...
                            <p>
	                            ...
	                            <!-- <span class="recordSighting" style="display:inline;"><a href="http://biocache.ala.org.au/share/sighting/${result.guid}">Record a sighting</a></span> -->	                            
	                            	...
	                            	&nbsp;<span class="recordSighting" style="display:inline;"><a href="#" onClick='javascript:window.open("http://biocache.ala.org.au/occurrences/taxa/${result.guid}")'>Occurrence count: ${result.occCount}</a></span>
	                            </c:if>
                                <!-- ${sectionText} -->
                            </p>
                        </c:when>
