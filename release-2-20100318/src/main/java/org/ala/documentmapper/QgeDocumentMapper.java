...
public class QgeDocumentMapper extends XMLDocumentMapper {
	...
	public QgeDocumentMapper() {
		...
		addTripleMapping("//h1[1]/following-sibling::p[1]/i[1]/text()|//h2[1]/following-sibling::p[1]/text()", 
		...
		addTripleMapping("//h3[contains(.,\"Description\")]/following-sibling::p[1]/text()|//h3[contains(.,\"What does it look like?\")]/following-sibling::p[1]/text()",
				subject, Predicates.DESCRIPTIVE_TEXT);
		
		addTripleMapping("//h3[contains(.,\"Diet\")]/following-sibling::p[1]/text()|//h3[contains(.,\"eat?\")]/following-sibling::p[1]/text()",
...
//		addTripleMapping("//h3[contains(.,\"breed\")]/following-sibling::p[1]/text()", 	
//				subject, Predicates.REPRODUCTION_TEXT);
		
		addTripleMapping("//h3[contains(.,\"Where does it live?\")]/following-sibling::p[1]/text()", 	
				subject, Predicates.HABITAT_TEXT);
		
		addTripleMapping("//h3[contains(.,\"Threatening processes\")]/following-sibling::p[1]/text()", 	
