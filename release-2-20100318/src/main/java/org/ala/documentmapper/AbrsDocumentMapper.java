...
public class AbrsDocumentMapper extends XMLDocumentMapper {
	...
	public AbrsDocumentMapper() {
		...
		addTripleMapping("//p[b[contains(.,\"Distribution\")]]/following::p[1]/descendant-or-self::*", 
				subject, Predicates.DISTRIBUTION_TEXT);
		
		addTripleMapping("//div[@id=\"body1column\"]/table[1]/tbody[1]/tr[1]/td[1]/b[contains(.,\"Features\")]/following::p[1]/descendant-or-self::*", 
				subject, Predicates.DESCRIPTIVE_TEXT);
		
		addTripleMapping("//div[@id=\"body1column\"]/table[1]/tbody[1]/tr[1]/td[1]/b[contains(.,\"Ecology/Way of Life\")]/following::p[1]/descendant-or-self::*", 
				subject, Predicates.ECOLOGICAL_TEXT);
		
		addTripleMapping("//div[@id=\"body1column\"]/table[1]/tbody[1]/tr[1]/td[1]/b[contains(.,\"Interaction with Humans/Threats\")]/following::p[1]/descendant-or-self::*", 
	...
	protected void extractProperties(List<ParsedDocument> pds, Document xmlDocument) throws Exception {
		...
		String source = "http://www.environment.gov.au/cgi-bin/";
		String appendix = "species-bank/";
