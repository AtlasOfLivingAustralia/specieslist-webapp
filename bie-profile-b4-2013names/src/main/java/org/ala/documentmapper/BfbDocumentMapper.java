...
/**
 * Document mapper for Bugs for Bugs
 *
 * @author Tommy Wang (Tommy.Wang@csiro.au)
 */
public class BfbDocumentMapper extends XMLDocumentMapper {

	/**
	 * Initialise the mapper, adding new XPath expressions
	 * for extracting content.
	 */
	public BfbDocumentMapper() {
        ...
        addDCMapping("//h1[1]/text()",subject, Predicates.DC_TITLE);
        addTripleMapping("//p[@class=\"photo\"]/a/@href", subject, Predicates.IMAGE_URL);
        addTripleMapping("//h1[1]/following-sibling::p[1]", subject, Predicates.DESCRIPTIVE_TEXT);
        addTripleMapping("//h1[contains(.,'environments')]/following-sibling::p[1]", subject, Predicates.HABITAT_TEXT);
        addTripleMapping("//h1[1]/text()", subject, Predicates.GENUS);
        addTripleMapping("//h1[1]/text()", subject, Predicates.SCIENTIFIC_NAME);
...
//		System.out.println(documentStr);
	...
	protected void extractProperties(List<ParsedDocument> pds, Document xmlDocument) throws Exception {
		...
		String subject = MappingUtils.getSubject();
		String baseUrl = "http://www.bugsforbugs.com.au";
		String sciName = null;
...
//                imageUrl = imageUrl.replaceAll(" ", "%20");
                ...
                String creator = getXPathSingleValue(xmlDocument, "//a[@href='" + imageUrl + "']/following-sibling::span/cite//text()"); 
                String description = getXPathSingleValue(xmlDocument, "//a[@href='" + imageUrl + "']/following-sibling::span/text()");

                if (description.contains(sciName)) {
                    ...
                    if(imageDoc!=null){
                        imageDoc.getDublinCore().put(Predicates.DC_RIGHTS.toString(), creator + ", http://www.bugsforbugs.com.au");
