...
//		addTripleMapping("//div[@class=\"headingSpeciesDetail\"]/text()[1]", subject, Predicates.COMMON_NAME);
	...
	protected void extractProperties(List<ParsedDocument> pds, Document xmlDocument) throws Exception {
		...
		pd.getDublinCore().put(Predicates.DC_LICENSE.toString(), "http://www.padil.gov.au/copyright.aspx");
		...
		for (Triple<String,String,String> triple: triples) {
			...
			if(predicate.equals(Predicates.PEST_STATUS.toString())) {
				...
				String creator = getXPathSingleValue(xmlDocument, "//dd[img[@src=\"" + imageUrl +"\"]]/following-sibling::dt[contains(.,\"Source:\")]/following-sibling::dd[1]/text()");
				...
				creatorMap.put(imageUrl, creator);
...
//				}
		...
		for (String imageUrl : imageUrls) {
			...
			String creator = creatorMap.get(imageUrl);
