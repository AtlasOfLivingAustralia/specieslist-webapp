...
public class Document {
	...
	/** The infosource uid for this document */
	...
	public String toString() {
		return "Document [created=" + created + ", filePath=" + filePath
				+ ", id=" + id  + ", infoSourceUid=" + infoSourceUid + ", identifier=" + identifier
				+ ", infoSourceId=" + infoSourceId + ", infoSourceName="
				+ infoSourceName + ", infoSourceUri=" + infoSourceUri
				+ ", mimeType=" + mimeType + ", modified=" + modified
				+ ", parentDocumentId=" + parentDocumentId + ", title=" + title
				+ ", uri=" + uri + "]";
	}
}