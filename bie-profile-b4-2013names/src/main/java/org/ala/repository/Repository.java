...
/**
 * The interface for BIE repository.
 *
...
public interface Repository {
	...
	/**
	 * Returns an output stream to the repository to allow streaming raw data straight into the
	 * repository. Useful for large payloads.
	 * 
	 * @param infoSourceId
	 * @param guid
	 * @param mimeType
	...
	/**
	 * Returns an output stream to the repository to allow streaming RDF straight into the
	 * repository. Useful for large payloads.
	 * 
	 * @param documentId
	 * @return
	 ...
	 * @param mimeType
	 * @param parentDocumentId nullable
	 *  * @param screenshot nullable
	 * @return Document giving details of where the raw content has been stored within the system.
	 * @throws IOException
	 */
	public Document storeDocument(int infoSourceId, String uri, byte[] content, String mimeType, Integer parentDocumentId, String screenshot) throws Exception;
	/**
