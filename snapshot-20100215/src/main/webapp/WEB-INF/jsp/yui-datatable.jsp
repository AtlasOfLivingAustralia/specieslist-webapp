                  ...
                  <script type="text/javascript">
                        ...
                        function loadDatatable(thisPropertyName, thisQuery, thisFacetQuery) {
                            ...
                            var formatTitleUrl = function(elCell, oRecord, oColumn, sData) {
                                ...
                                elCell.innerHTML = "<a href='" + "${pageContext.request.contextPath}/" + oRecord.getData("urlMapper") + "/" + oRecord.getData("guid") + "' title='view record details'>" + cellContent + "</a>";
                            };
                            ...
                            myDataSource.responseSchema = {
                                resultsList: "solrResults.searchResults",
                                fields: ["pid","guid","title","contentModel","contentModelInitial","contentModelLabel","urlMapper","rank", "rankId"],
                                metaFields: {
                                    totalRecords: "solrResults.totalRecords",
                                    paginationRecordOffset : "solrResults.startIndex",
                                    sortKey: "solrResults.sort",
                                    sortDir: "solrResults.dir"
                                }
                            };
                            ...
                            var myColumnDefs = [
                                ...
                                {key:"dc3.title", field:"title", sortable:true, label:"Title", formatter:formatTitleUrl, width: 400}, // , formatter:formatTitleUrl
